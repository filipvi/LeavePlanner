        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkingDaysUsed = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeaveReplacementUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LeaveReplacementUser_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LeaveReplacementUser_Leave_LeaveId",
                        column: x => x.LeaveId,
                        principalSchema: "dbo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveReplacementUser_ApplicationUserId",
                schema: "dbo",
                table: "LeaveReplacementUser",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_LeaveReplacementUser_LeaveId",
                schema: "dbo",
                table: "LeaveReplacementUser",
                column: "LeaveId");
        }
